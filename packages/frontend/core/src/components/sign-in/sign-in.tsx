...
import { LocalWorkspaceIcon, PublishIcon } from '@blocksuite/icons/rc';
  ...
  return (
    <AuthContainer>
      ...
      <AuthContent>
        ...
        {/* Local email/password authentication disabled for notes9 - Auth0 only */}
          ...
          <>
            <div className={style.authMessage}>
              ...
              <Trans i18nKey="com.affine.auth.sign.message">
                ...
                you agree to notes9&apos;s <a href="https://affine.pro/terms" target="_blank" rel="noreferrer">Terms of Conditions</a> and <a href="https://affine.pro/privacy" target="_blank" rel="noreferrer">Privacy Policy</a>.
            </Trans>
            </div>
